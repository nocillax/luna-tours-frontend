  ...
  return (
    <section className="py-16 px-4 bg-[var(--earth-darkest)] relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <button className="px-8 py-3 font-bold bg-[var(--earth-accent)] text-[var(--earth-darkest)] rounded-md hover:bg-[var(--earth-medium)] hover:text-[var(--earth-accent)] transition-all duration-300 shadow-lg">
