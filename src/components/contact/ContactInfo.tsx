          ...
          <div className="space-y-2">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-[var(--earth-light)]">+81 3-1234-5678</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg
              ...
              <div>
                ...
                <p className="text-[var(--earth-light)]">+1 (555) 123-4567</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-[var(--earth-light)]">info@lunatours.com</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg
              ...
              <div>
                <p className="text-sm text-[var(--earth-light)]/70">Support</p>
