    ...
    <div className="lg:col-span-1">
      <div className="bg-[var(--earth-dark)]/30 rounded-lg p-8 h-full">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            <div className="flex items-start">
              <PhoneIcon className="h-5 w-5 mr-2 text-[var(--earth-accent)] mt-1" />
              <div>
                <p className="text-[var(--earth-light)]">Bookings & Support:</p>
            ...
            <div className="flex items-start">
              <PhoneIcon className="h-5 w-5 mr-2 text-[var(--earth-accent)] mt-1" />
              <div>
                <p className="text-[var(--earth-light)]">Emergency Contact:</p>
                <p className="text-[var(--earth-highlight)] font-semibold">
                  +81 3-8765-4321
                </p>
              </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            <div className="flex items-start">
              <EnvelopeIcon className="h-5 w-5 mr-2 text-[var(--earth-accent)] mt-1" />
              <div>
                <p className="text-[var(--earth-light)]">General Inquiries:</p>
                <p className="text-[var(--earth-highlight)] font-semibold">
                  info@lunatours.jp
                </p>
              </div>
            ...
            <div className="flex items-start">
              <EnvelopeIcon className="h-5 w-5 mr-2 text-[var(--earth-accent)] mt-1" />
              <div>
                <p className="text-[var(--earth-light)]">Bookings:</p>
                <p className="text-[var(--earth-highlight)] font-semibold">
                  bookings@lunatours.jp
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Social Media - keeping SVG paths since these are specific social icons not in Heroicons */}
        <div>
          <h3 className="text-[var(--earth-accent)] font-semibold text-lg mb-2 font-montserrat">
            Follow Us
          </h3>
